...
main() {
    ...
    [ -f "$DESKTOP_SERVICE_SOURCE" ] || error "Missing desktop app service template: $DESKTOP_SERVICE_SOURCE"
    [ -f "$DESKTOP_DOCTOR_SOURCE" ] || error "Missing desktop doctor template: $DESKTOP_DOCTOR_SOURCE"
