...
function buildLinuxExternalOpenHelpers() {
  return (
    ...
    `for(let __codexKey of[\`LD_PRELOAD\`,\`NODE_OPTIONS\`,\`NODE_PATH\`,\`NODE_REPL_EXTERNAL_MODULE\`,\`ELECTRON_RUN_AS_NODE\`,\`ELECTRON_NO_ASAR\`,\`ELECTRON_ENABLE_LOGGING\`,\`VSCODE_NODE_OPTIONS\`,\`VSCODE_NODE_REPL_EXTERNAL_MODULE\`,\`npm_config_node_options\`,\`NPM_CONFIG_NODE_OPTIONS\`,\`CHROME_DESKTOP\`,\`ELECTRON_RENDERER_URL\`,\`CODEX_ELECTRON_RESOURCES_PATH\`,\`CODEX_ELECTRON_USER_DATA_DIR\`,\`CODEX_LINUX_APP_ID\`,\`CODEX_LINUX_APP_DISPLAY_NAME\`,\`CODEX_LINUX_WEBVIEW_PORT\`])delete __codexEnv[__codexKey];` +
    `let __codexLdState=process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE??process.env.CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_STATE,__codexLdValue=process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE==null?process.env.CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_VALUE:process.env.CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE;__codexLdState===\`unset\`?delete __codexEnv.LD_LIBRARY_PATH:__codexLdState===\`empty\`?__codexEnv.LD_LIBRARY_PATH=\`\`:__codexLdState===\`value\`&&typeof __codexLdValue===\`string\`?__codexEnv.LD_LIBRARY_PATH=__codexLdValue:void 0;` +
    `for(let __codexKey of[\`CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_STATE\`,\`CODEX_LINUX_ORIGINAL_LD_LIBRARY_PATH_VALUE\`,\`CODEX_LINUX_APP_LD_LIBRARY_PATH\`,\`CODEX_LINUX_HOST_LD_LIBRARY_PATH_STATE\`,\`CODEX_LINUX_HOST_LD_LIBRARY_PATH_VALUE\`])delete __codexEnv[__codexKey];` +
    `return __codexEnv}` +
