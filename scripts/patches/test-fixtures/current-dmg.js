...
function currentChromePluginAppServerSourceBundleFixture() {
  return [
    ...
    "function bJ(e,t){let n=(0,i.relative)((0,i.resolve)(t),(0,i.resolve)(e));return n===``||n!==`..`&&!n.startsWith(`..${i.sep}`)&&!(0,i.isAbsolute)(n)}function Mq(e){return e}function Eq(e){return e.entries.filter(t=>!kq(t,e))}function kq(e,t){let n=Mq(e);return n!=null&&n.nativeHostNames.includes(t.nativeHostName)&&(0,i.isAbsolute)(n.paths.extensionHostPath)&&bJ(n.paths.extensionHostPath,t.pluginCacheRoot)}",
