...
test_desktop_parity_smoke_script_syntax() {
    ...
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "codex-parity-plugin"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "codex-parity-toggle-skill"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "codex-parity-fs"
    ...
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "mcp tool call fixture"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "isolated plugin install fixture"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "isolated skill config fixture"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "filesystem fixture"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "filesystem mutation fixture"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "installed plugin summary"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "plugin/install"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "plugin/uninstall"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "plugin/installed"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "plugin/read"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "modelProvider/capabilities/read"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "experimentalFeature/list"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "permissionProfile/list"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "collaborationMode/list"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "skills/config/write"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/createDirectory"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/copy"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/getMetadata"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/readDirectory"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/readFile"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/remove"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/unwatch"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/watch"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/writeFile"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "fs/changed"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "thread/start"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "externalAgentConfig/import"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "external agent no-op import"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "experimentalFeature/enablement/set"
    assert_contains "$REPO_DIR/scripts/desktop-parity-smoke.js" "experimental feature no-op enablement set"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/PluginInstalledParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/PluginReadParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/PluginInstallParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/PluginUninstallParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/ModelProviderCapabilitiesReadParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/ExperimentalFeatureListParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/PermissionProfileListParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/CollaborationModeListParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/SkillsConfigWriteParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsCreateDirectoryParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsCopyParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsGetMetadataParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsReadDirectoryParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsReadFileParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsRemoveParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsUnwatchParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsWatchParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsWriteFileParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/FsChangedNotification.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/McpResourceReadParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/McpServerToolCallParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/ExternalAgentConfigImportParams.json"
    assert_contains "$REPO_DIR/scripts/app-server-schema-guard.js" "v2/ExternalAgentConfigImportResponse.json"
