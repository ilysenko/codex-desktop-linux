...
CODEX_LINUX_APP_LD_LIBRARY_PATH="${electronLibPath}:${runtimeLibPath}"\
export CODEX_LINUX_APP_LD_LIBRARY_PATH\
export LD_LIBRARY_PATH="$CODEX_LINUX_APP_LD_LIBRARY_PATH''${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}"\
