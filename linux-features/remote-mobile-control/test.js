...
test("Linux remote-control client enrollment accepts upstream-native compatibility", () => {
  ...
  assert.equal(applyLinuxRemoteControlClientAccountCompatibilityPatch(source), source);
});
