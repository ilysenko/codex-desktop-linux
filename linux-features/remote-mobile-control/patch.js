...
function linuxDeviceKeyProviderSource({ cryptoVar, fsVar, pathVar }) {
  return [
    ...
    `${fsVar}.mkdirSync(${pathVar}.join(codexLinuxRemoteControlConfigRoot,\`chatgpt-desktop\`),{recursive:!0,mode:448});`,
    `return ${pathVar}.join(codexLinuxRemoteControlConfigRoot,\`chatgpt-desktop\`,\`remote-control-device-keys-v1.json\`)`,
    "}",
