...
async function codexLinuxAppshotCapture({origin:e,requestId:t,bundleIdentifier:n,windowManager:r}){let i=await codexLinuxAppshotFocusedWindow(!0),a=i.focusedWindow,o=i.returnWindow,s=i.backend===\`hyprland\`&&a!=null&&o!=null&&Number(a.window_id)!==Number(o.window_id);try{i=await codexLinuxAppshotPrepareWindowForCapture(i);let n=codexLinuxAppshotWindowForRenderer(i.focusedWindow);if(n==null){codexLinuxAppshotSend(r,e,t,{type:\`failed\`});return}codexLinuxAppshotSend(r,e,t,{type:\`metadata\`,app:{bundleIdentifier:n.bundleIdentifier,name:n.name,windowTitle:n.windowTitle,iconSmallDataURL:null}});let a=await codexLinuxAppshotAccessibilityNodes(i.focusedWindow,n.bundleIdentifier),o=codexLinuxAppshotAccessibilityText(i.focusedWindow,a.nodes,a.error);typeof o==\`string\`&&o.length>0&&codexLinuxAppshotSend(r,e,t,{type:\`axText\`,text:o});let s=await codexLinuxAppshotScreenshot(i.focusedWindow,i.windows);if(s==null||typeof s.dataURL!=\`string\`||s.dataURL.length===0){codexLinuxAppshotSend(r,e,t,{type:\`failed\`});return}codexLinuxAppshotSend(r,e,t,{type:\`screenshot\`,screenshotDataURL:s.dataURL});codexLinuxAppshotSend(r,e,t,{type:\`completed\`,transitionSnapshotDataURL:s.dataURL})}finally{s&&!await codexLinuxAppshotHyprlandFocusWindow(o)&&codexLinuxAppshotWarn(\`hyprland-restore-focus-failed\`,{windowId:o?.window_id})}}
