...
const RUNTIME_VERSION = "conversation-mode-v23";
...
function conversationRuntimeSource() {
  return [
    ...
    `function chatSurfaceOpen(){return typeof document!=="undefined"&&!!document.querySelector?.('button[aria-label="Close chat"]')}`,
