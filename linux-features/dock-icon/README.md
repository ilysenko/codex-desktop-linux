...
and applies the selected icon to Linux Electron windows. The selection remains
owned by the upstream `dockIconPreference` setting. The Codex option follows
the system light or dark appearance, matching the macOS behavior.
