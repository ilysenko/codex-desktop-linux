...
test("current shared schedule contract accepts renamed parser fields and summary flags", () => {
  const source = [
    "function $vn(e,t,n){let r=LY(e),i=LY(t);return r!=null&&i!=null?syn(r,i):n.dtstart?syn(n.dtstart.getHours(),n.dtstart.getMinutes()):UY}function LY(e){return Array.isArray(e)?typeof e[0]==`number`?e[0]:null:typeof e==`number`?e:null}",
    "function PY(e){let i=parse(e),o=minute(i),r=original(e),a=days(i);return{freq:i.freq,hasMultipleTimeValues:Array.isArray(i.byhour)&&i.byhour.length>1||Array.isArray(i.byminute)&&i.byminute.length>1,interval:Math.max(1,Math.round(i.interval??1)),minute:o,origOptions:r.origOptions,rruleText:e,time:$vn(i.byhour,i.byminute,i),weekdays:a}}",
    "function qvn(e,t,n=!0){if(!e||e.hasMultipleTimeValues)return null;let n2=days(e.weekdays),r=n2.length===7;if(e.freq!==`DAILY`&&e.freq!==`WEEKLY`)return null;let a=uvn(e.time,t);return a?Qvn({intl:t,isEveryDay:r,timeLabel:a,weekdays:n2}):null}",
  ].join("");
