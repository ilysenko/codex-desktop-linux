...
codexPetOverlayStabilityFlushDrag(e,t){let n=this.codexPetOverlayStabilityData(),r=this.window;if(!n.dragActive||n.rendererId!==e||r==null||r.isDestroyed()||r.webContents.id!==e)return;if(this.windowServerDragActive){n.finalDragFlushed=!0;return}this.codexPetOverlayStabilityClearGeometryTimer(!1);let i=${captures.screenBinding}.screen.getCursorScreenPoint(),a=Number(t?.pointerScreenX),o=Number(t?.pointerScreenY),s=Number.isFinite(a)?a:i.x,c=Number.isFinite(o)?o:i.y,currentDragState=this.dragState;if(currentDragState!=null){let e=${captures.cursorNormalizer}(this.compositionHost.getCursorPosition()),t=currentDragState.getCursorPointForSource({native:currentDragState.cursorSource==="native"?e:null,renderer:{x:s,y:c}});t!=null&&(n.pendingDragPoint={x:t.x,y:t.y})}let u=n.pendingDragPoint;n.pendingDragPoint=null;u!=null&&this.moveDragToPointer(r,u);n.finalDragFlushed=!0}
