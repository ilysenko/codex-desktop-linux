...
function buildPetOverlayMethods(settings) {
  return [
    ...
    "codexPetOverlayFinishNiriProcess(){this.codexPetOverlayNiriProcessCount=Math.max(0,(this.codexPetOverlayNiriProcessCount??1)-1);if(this.codexPetOverlayNiriProcessCount===0){let e=this.codexPetOverlayNiriDragState;e!=null&&this.codexPetOverlayPumpNiriDrag(e)}}",
    ...
    "codexPetOverlayScheduleNiriHints(e){if(!this.codexPetOverlayShouldUseNiri()||this.dragState!=null||this.codexPetOverlayNiriDragState!=null||this.codexPetOverlayNiriDragCallOwner!=null)return;try{this.codexPetOverlayNiriTimers?.forEach(clearTimeout)}catch{}let t=(this.codexPetOverlayNiriEpoch??0)+1;this.codexPetOverlayNiriEpoch=t,this.codexPetOverlayNiriTimers=[0,80,300,1000].map(n=>{let r=setTimeout(()=>{try{e==null||e.isDestroyed?.()||this.codexPetOverlayApplyNiriHints(e,t)}catch{}},n);try{r.unref?.()}catch{}return r})}",
