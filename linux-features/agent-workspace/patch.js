...
function permissionConfigView(config){
  ...
  return h("div",{className:"rounded-md border border-token-border-default bg-token-bg-primary p-3 text-sm"},
    ...
    hasPermissionFile&&!locked?h("div",{className:"mt-2 text-xs text-token-text-secondary"},"The permission file is open. ChatGPT session permissions apply after hidden-workspace approval."):null,
    !hasPermissionFile&&!locked?h("div",{className:"mt-2 text-xs text-token-text-secondary"},"ChatGPT session permissions apply after hidden-workspace approval."):null,
...
function pendingApprovalSummary(pending){
  ...
  var purpose=params.purpose||preview?.purpose||"ChatGPT agent workspace";
  ...
  return h("section",{className:"rounded-md border border-yellow-500/40 bg-token-main-surface-secondary p-3 text-sm shadow-sm"},
    h("div",{className:"flex items-start justify-between gap-3"},
      h("div",{className:"min-w-0"},
        ...
        h("div",{className:"mt-1 text-token-text-secondary"},"ChatGPT Desktop wants to start an agent-controlled Linux workspace that is separate from your visible desktop."),
...
function AgentWorkspacesSettings(){
  ...
  var refresh=React.useCallback(async function(){
    ...
    setPermissionConfig(nextPermissionConfig||{configured:false,restricted:false,message:"No workspace permission file detected; ChatGPT session permissions apply"});
  ...
  function previewStart(){
    ...
    callAgentWorkspace("workspaceOpenProfile",{
      ...
      dryRun:true,
      purpose:purpose||"ChatGPT agent workspace",
      runSetup:true,
  ...
  function startSavedWorkspace(savedProfile){
    ...
    requestStartApproval("workspaceOpenProfile",{
      profileId:id,
      purpose:profileSummary(savedProfile)||"ChatGPT agent workspace",
      runSetup:true,
      startupWaitWindow:true
    },"Start "+id);
  }
  ...
  function startStoppedWorkspace(workspace){
    ...
    requestStartApproval("workspaceStart",{
      ...
      purpose:workspacePurpose(workspace)||"ChatGPT agent workspace"
